...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  useEffect(() => {
    ...
    const tickerFn = () => {
      ...
      // LOCAL ADDITION: re-measure the target every tick. Upstream measures it
      // once, on enter, which assumes targets stand still — inside a marquee
      // the logo is still gliding to a halt (and would drift away for good
      // without pauseOnHover), so the frame was left framing empty space.
      if (activeTarget) {
